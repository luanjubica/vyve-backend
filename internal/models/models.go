...
// OnboardingSteps is a custom type for PostgreSQL JSONB arrays
type OnboardingSteps []string

func (o OnboardingSteps) Value() (driver.Value, error) {
	if len(o) == 0 {
		return "[]", nil
	}
...
func (o *OnboardingSteps) Scan(value interface{}) error {
	if value == nil {
		*o = []string{}
		return nil
	}
...
type User struct {
	...
	// Onboarding fields with proper types:
	OnboardingCompleted bool            `gorm:"default:false" json:"onboarding_completed"`
	OnboardingSteps     OnboardingSteps `gorm:"type:jsonb" json:"onboarding_steps"`
